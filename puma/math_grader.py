"""
Robust math answer comparison.
Core logic copied from DEER (https://github.com/...DEER/utils/grader.py and parser.py).
Original credits:
- Hendrycks' MATH release (math_equivalence)
...
# =============================================================================
# String normalization (from DEER parser.py)
# =============================================================================
...
unit_texts = [
    ...
    "rise", "a . m", "th", "sq", "mark", "l", "toy", "coin", "sq . m",
    "gallon", "profit", "minw", "yr", "women", "feet", "am", "pm", "hr",
    "cu cm", "square", "are", "rupee", "rounds", "cubic", "cc", "mtr", "s",
    "ohm", "number", "kmph", "day", "hour", "minute", "min", "second",
    "man", "woman", "sec", "cube", "mt", "sq inch", "mp", "hectare", "more",
    "sec", "unit", "cu . m", "cm 2", "rs .", "rs", "kg", "g", "month",
    "km", "m", "cm", "mm", "apple", "liter", "loss", "yard", "pure",
    "year", "increase", "decrease", "d", "less", "Surface", "litre",
    "pi sq m", "s .", "metre", "meter", "inch",
]
...
# =============================================================================
# Math comparison (from DEER grader.py)
# =============================================================================
...
def check_is_correct(pred, gt, timeout=True):
    """Main entry point: normalize both strings then compare."""
